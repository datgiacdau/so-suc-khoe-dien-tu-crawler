...
public class VietnamLocationCrawlerSub {
    ...
    //Nhập vào số lượng tỉnh muốn cào 
    public static int getProvinceCount() {
        
        String provinceCountStr = JOptionPane.showInputDialog("Bạn muốn cào bao nhiêu tỉnh (max 63, default 2):", 2);
        int provinceCount = 2;
        try {
            provinceCount = Integer.parseInt(provinceCountStr);
        } catch (Exception e) {
    ...
    //Đưa vào số lượng tỉnh muốn cào (1-63), vì để cào hết 63 tỉnh mất khoảng 30-45phút
